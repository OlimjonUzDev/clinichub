...
class ClinicsViewSetTestCase(APITestCase):
    """``MedicalCenter`` va ``Clinic`` view'lari uchun ruxsatlarni tekshiradi."""

    def setUp(self):
        """Testlar uchun foydalanuvchilar, tibbiyot markazi va klinika yaratadi."""
    ...
    def test_anonymous_can_list_medicalcenters(self):
        """Anonim foydalanuvchi tibbiyot markazlari ro'yxatini ko'ra olishini tekshiradi."""
    ...
    def test_anonymous_cannot_create_medicalcenter(self):
        """Anonim foydalanuvchi tibbiyot markazi yarata olmasligini (401) tekshiradi."""
    ...
    def test_patient_cannot_create_medicalcenter(self):
        """'patient' rolidagi foydalanuvchi tibbiyot markazi yarata olmasligini (403) tekshiradi."""
    ...
    def test_admin_can_create_medicalcenter(self):
        """'admin' rolidagi foydalanuvchi tibbiyot markazi yarata olishini (201) tekshiradi."""
    ...
    def test_anonymous_can_list_clinics(self):
        """Anonim foydalanuvchi klinikalar ro'yxatini ko'ra olishini tekshiradi."""
    ...
    def test_anonymous_cannot_create_clinics(self):
        """Anonim foydalanuvchi klinika yarata olmasligini (401) tekshiradi."""
    ...
    def test_patient_cannot_create_clinic(self):
        """'patient' rolidagi foydalanuvchi klinika yarata olmasligini (403) tekshiradi."""
    ...
    def test_admin_can_create_clinic(self):
        """'admin' rolidagi foydalanuvchi klinika yarata olishini (201) tekshiradi."""
